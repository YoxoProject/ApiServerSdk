...
public class Coords {
  ...
  public Coords x(@javax.annotation.Nullable Integer x) {
    this.x = x;
    return this;
  }
  ...
  public Coords y(@javax.annotation.Nullable Integer y) {
    this.y = y;
    return this;
  }
  ...
  public Coords z(@javax.annotation.Nullable Integer z) {
    this.z = z;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.x, coords.x) &&
        Objects.equals(this.y, coords.y) &&
        Objects.equals(this.z, coords.z);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Coords
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Coords.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Coords is not found in the empty JSON string", Coords.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Coords.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Coords` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Coords.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Coords' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Coords> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Coords.class));

       return (TypeAdapter<T>) new TypeAdapter<Coords>() {
           @Override
           public void write(JsonWriter out, Coords value) throws IOException {
  ...
  /**
   * Create an instance of Coords given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Coords
   * @throws IOException if the JSON string is invalid with respect to Coords
   */
  public static Coords fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Coords.class);
  }

  /**
   * Convert an instance of Coords to an JSON string
   *
   * @return JSON string
   */
