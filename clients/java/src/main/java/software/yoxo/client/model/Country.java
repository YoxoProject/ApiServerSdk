...
import software.yoxo.client.model.CountryEntry;
...
public class Country {
  ...
  private List<CountryEntry> data = new ArrayList<>();
  ...
  public Country data(@javax.annotation.Nullable List<CountryEntry> data) {
    this.data = data;
    return this;
  }

  public Country addDataItem(CountryEntry dataItem) {
    if (this.data == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<CountryEntry> getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable List<CountryEntry> data) {
    this.data = data;
  }


  public Country metadata(@javax.annotation.Nullable Metadata metadata) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, country.data) &&
        Objects.equals(this.metadata, country.metadata);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Country.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Country is not found in the empty JSON string", Country.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Country.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Country` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            CountryEntry.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
