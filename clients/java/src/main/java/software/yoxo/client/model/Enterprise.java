...
public class Enterprise {
  ...
  private List<EnterpriseEntry> data = new ArrayList<>();
  ...
  public Enterprise data(@javax.annotation.Nullable List<EnterpriseEntry> data) {
    this.data = data;
    return this;
  }

  public Enterprise addDataItem(EnterpriseEntry dataItem) {
    if (this.data == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<EnterpriseEntry> getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable List<EnterpriseEntry> data) {
    this.data = data;
  }


  public Enterprise metadata(@javax.annotation.Nullable Metadata metadata) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, enterprise.data) &&
        Objects.equals(this.metadata, enterprise.metadata);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Enterprise.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Enterprise is not found in the empty JSON string", Enterprise.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Enterprise.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Enterprise` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            EnterpriseEntry.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
