...
public class EnterpriseBasic extends EnterpriseEntry {
   ...
   * @throws IOException if the JSON Element is invalid with respect to EnterpriseBasic
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EnterpriseBasic.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EnterpriseBasic is not found in the empty JSON string", EnterpriseBasic.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EnterpriseBasic.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EnterpriseBasic' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EnterpriseBasic> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EnterpriseBasic.class));

       return (TypeAdapter<T>) new TypeAdapter<EnterpriseBasic>() {
           @Override
           public void write(JsonWriter out, EnterpriseBasic value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EnterpriseBasic read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EnterpriseBasic given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EnterpriseBasic
   * @throws IOException if the JSON string is invalid with respect to EnterpriseBasic
   */
  public static EnterpriseBasic fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EnterpriseBasic.class);
  }

  /**
   * Convert an instance of EnterpriseBasic to an JSON string
   *
   * @return JSON string
   */
