...
public class EnterpriseBet {
  ...
  public EnterpriseBet type(@javax.annotation.Nullable TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public EnterpriseBet name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public EnterpriseBet age(@javax.annotation.Nullable Integer age) {
    this.age = age;
    return this;
  }
  ...
  public EnterpriseBet description(@javax.annotation.Nullable String description) {
  ...
  public EnterpriseBet services(@javax.annotation.Nullable String services) {
  ...
  public EnterpriseBet owner(@javax.annotation.Nullable String owner) {
    this.owner = owner;
    return this;
  }
  ...
  public EnterpriseBet flag(@javax.annotation.Nullable String flag) {
    this.flag = flag;
    return this;
  }
  ...
  public EnterpriseBet cadres(@javax.annotation.Nullable List<String> cadres) {
    this.cadres = cadres;
    return this;
  }

  public EnterpriseBet addCadresItem(String cadresItem) {
    if (this.cadres == null) {
  ...
  public EnterpriseBet employees(@javax.annotation.Nullable List<String> employees) {
    this.employees = employees;
    return this;
  }

  public EnterpriseBet addEmployeesItem(String employeesItem) {
  ...
  public EnterpriseBet contractsDone(@javax.annotation.Nullable Integer contractsDone) {
  ...
  public EnterpriseBet disputes(@javax.annotation.Nullable Integer disputes) {
  ...
  public EnterpriseBet contractsSuccess(@javax.annotation.Nullable Double contractsSuccess) {
  ...
  public EnterpriseBet turnover(@javax.annotation.Nullable Integer turnover) {
  ...
  public EnterpriseBet permissions(@javax.annotation.Nullable List<EnterprisePermission> permissions) {
    this.permissions = permissions;
    return this;
  }

  public EnterpriseBet addPermissionsItem(EnterprisePermission permissionsItem) {
  ...
  public EnterpriseBet bank(@javax.annotation.Nullable EnterpriseBank bank) {
    this.bank = bank;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, enterpriseBet.type) &&
        Objects.equals(this.name, enterpriseBet.name) &&
        Objects.equals(this.age, enterpriseBet.age) &&
        Objects.equals(this.description, enterpriseBet.description) &&
        Objects.equals(this.services, enterpriseBet.services) &&
        Objects.equals(this.owner, enterpriseBet.owner) &&
        Objects.equals(this.flag, enterpriseBet.flag) &&
        Objects.equals(this.cadres, enterpriseBet.cadres) &&
        Objects.equals(this.employees, enterpriseBet.employees) &&
        Objects.equals(this.contractsDone, enterpriseBet.contractsDone) &&
        Objects.equals(this.disputes, enterpriseBet.disputes) &&
        Objects.equals(this.contractsSuccess, enterpriseBet.contractsSuccess) &&
        Objects.equals(this.turnover, enterpriseBet.turnover) &&
        Objects.equals(this.permissions, enterpriseBet.permissions) &&
        Objects.equals(this.bank, enterpriseBet.bank) &&
        Objects.equals(this.bets, enterpriseBet.bets) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, name, age, description, services, owner, flag, cadres, employees, contractsDone, disputes, contractsSuccess, turnover, permissions, bank, bets, betsRewardRedistributed, betTotal, betActive);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("type", "name", "age", "description", "services", "owner", "flag", "cadres", "employees", "contractsDone", "disputes", "contractsSuccess", "turnover", "permissions", "bank", "bets", "betsRewardRedistributed", "betTotal", "betActive"));
      ...
      if (jsonObj.get("bets") != null && !jsonObj.get("bets").isJsonNull()) {
        ...
        if (jsonArraybets != null) {
          ...
          if (!jsonObj.get("bets").isJsonArray()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `bets` to be an array in the JSON string but got `%s`", jsonObj.get("bets").toString()));
          }

          // validate the optional field `bets` (array)
          for (int i = 0; i < jsonArraybets.size(); i++) {
            EnterpriseBetItem.validateJsonElement(jsonArraybets.get(i));
          };
        }
      }
  }
