...
import software.yoxo.client.model.SkillEntry;
...
public class Skill {
  ...
  private List<SkillEntry> data = new ArrayList<>();
  ...
  public Skill data(@javax.annotation.Nullable List<SkillEntry> data) {
    this.data = data;
    return this;
  }

  public Skill addDataItem(SkillEntry dataItem) {
    if (this.data == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<SkillEntry> getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable List<SkillEntry> data) {
    this.data = data;
  }


  public Skill metadata(@javax.annotation.Nullable Metadata metadata) {
  ...
  public boolean equals(Object o) {
    ...
    Skill skill = (Skill) o;
    return Objects.equals(this.data, skill.data) &&
        Objects.equals(this.metadata, skill.metadata);
  }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            SkillEntry.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
