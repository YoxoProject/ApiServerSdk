...
class TestAlliance(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Alliance:
        """Test Alliance
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Alliance`
        """
        model = Alliance()
        if include_optional:
            return Alliance(
                data = [
                    yoxo_api_client.models.alliance_entry.AllianceEntry(
                        name = 'Poufsouffle', 
                        description = '', 
                ...
                metadata = yoxo_api_client.models.metadata.Metadata(
                    data_type = 'example', 
                    server = 'red', 
