...
class TestAllianceBank(unittest.TestCase):
    """AllianceBank unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AllianceBank:
        """Test AllianceBank
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AllianceBank`
        """
        model = AllianceBank()
        if include_optional:
            return AllianceBank(
