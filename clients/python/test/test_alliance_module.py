...
class TestAllianceModule(unittest.TestCase):
    """AllianceModule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AllianceModule:
        """Test AllianceModule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AllianceModule`
        """
