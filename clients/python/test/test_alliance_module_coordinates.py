...
class TestAllianceModuleCoordinates(unittest.TestCase):
    """AllianceModuleCoordinates unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AllianceModuleCoordinates:
        """Test AllianceModuleCoordinates
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AllianceModuleCoordinates`
        """
        model = AllianceModuleCoordinates()
        if include_optional:
            return AllianceModuleCoordinates(
                x = 56,
                z = 56
            )
        else:
    ...
    def testAllianceModuleCoordinates(self):
        """Test AllianceModuleCoordinates"""
