...
class TestAlliancePrimeBoost(unittest.TestCase):
    """AlliancePrimeBoost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlliancePrimeBoost:
        """Test AlliancePrimeBoost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlliancePrimeBoost`
        """
        model = AlliancePrimeBoost()
        if include_optional:
            return AlliancePrimeBoost(
    ...
    def testAlliancePrimeBoost(self):
        """Test AlliancePrimeBoost"""
