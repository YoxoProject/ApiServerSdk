...
class TestAlliancePrimeBooster(unittest.TestCase):
    """AlliancePrimeBooster unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlliancePrimeBooster:
        """Test AlliancePrimeBooster
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlliancePrimeBooster`
        """
        model = AlliancePrimeBooster()
        if include_optional:
            return AlliancePrimeBooster(
                username = 'Romaindu35',
                boost_type = 'PREMIUM',
                boost_value = 1
            )
    ...
    def testAlliancePrimeBooster(self):
        """Test AlliancePrimeBooster"""
