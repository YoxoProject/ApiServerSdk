...
class TestAllianceRelation(unittest.TestCase):
    """AllianceRelation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AllianceRelation:
        """Test AllianceRelation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AllianceRelation`
        """
        model = AllianceRelation()
        if include_optional:
