...
class TestAllianceTaxes(unittest.TestCase):
    """AllianceTaxes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AllianceTaxes:
        """Test AllianceTaxes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AllianceTaxes`
        """
        model = AllianceTaxes()
        if include_optional:
            return AllianceTaxes(
                hdv_tax = 0.1,
                weekly_salary = 500,
                station_ticket = 1000,
                notation_tax = 10,
