...
class TestAllianceVoteHistory(unittest.TestCase):
    """AllianceVoteHistory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AllianceVoteHistory:
        """Test AllianceVoteHistory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AllianceVoteHistory`
        """
        model = AllianceVoteHistory()
        if include_optional:
            return AllianceVoteHistory(
    ...
    def testAllianceVoteHistory(self):
        """Test AllianceVoteHistory"""
