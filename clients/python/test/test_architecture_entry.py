...
class TestArchitectureEntry(unittest.TestCase):
    """ArchitectureEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ArchitectureEntry:
        """Test ArchitectureEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArchitectureEntry`
        """
    ...
    def testArchitectureEntry(self):
        """Test ArchitectureEntry"""
