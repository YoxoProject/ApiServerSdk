...
class TestCerealGlobalMarketEntry(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CerealGlobalMarketEntry:
        """Test CerealGlobalMarketEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CerealGlobalMarketEntry`
        """
        model = CerealGlobalMarketEntry()
        if include_optional:
            return CerealGlobalMarketEntry(
                prices_texture = '',
                sales_texture = '',
                stocks_texture = '',
    ...
    def testCerealGlobalMarketEntry(self):
        """Test CerealGlobalMarketEntry"""
