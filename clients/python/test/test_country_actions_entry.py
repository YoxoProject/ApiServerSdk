...
class TestCountryActionsEntry(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CountryActionsEntry:
        """Test CountryActionsEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CountryActionsEntry`
        """
        model = CountryActionsEntry()
        if include_optional:
            return CountryActionsEntry(
    ...
    def testCountryActionsEntry(self):
        """Test CountryActionsEntry"""
