...
class TestCountryBankEntry(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CountryBankEntry:
        """Test CountryBankEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CountryBankEntry`
        """
        model = CountryBankEntry()
        if include_optional:
            return CountryBankEntry(
                balance = 56,
                owners = [
                    ''
                    ],
