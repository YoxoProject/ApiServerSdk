...
class TestCountryCoordinates(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CountryCoordinates:
        """Test CountryCoordinates
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CountryCoordinates`
        """
        model = CountryCoordinates()
        if include_optional:
    ...
    def testCountryCoordinates(self):
        """Test CountryCoordinates"""
