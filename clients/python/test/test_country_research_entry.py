...
class TestCountryResearchEntry(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CountryResearchEntry:
        """Test CountryResearchEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CountryResearchEntry`
        """
        model = CountryResearchEntry()
        if include_optional:
    ...
    def testCountryResearchEntry(self):
        """Test CountryResearchEntry"""
