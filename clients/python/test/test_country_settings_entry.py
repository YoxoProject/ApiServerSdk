...
class TestCountrySettingsEntry(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CountrySettingsEntry:
        """Test CountrySettingsEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CountrySettingsEntry`
        """
        model = CountrySettingsEntry()
        if include_optional:
            return CountrySettingsEntry(
    ...
    def testCountrySettingsEntry(self):
        """Test CountrySettingsEntry"""
