...
class TestDividendeClassementEntry(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DividendeClassementEntry:
        """Test DividendeClassementEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DividendeClassementEntry`
        """
        model = DividendeClassementEntry()
        if include_optional:
            return DividendeClassementEntry(
                pays = '',
                montant = 1.337
            )
        else:
    ...
    def testDividendeClassementEntry(self):
        """Test DividendeClassementEntry"""
