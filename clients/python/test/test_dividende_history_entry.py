...
class TestDividendeHistoryEntry(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DividendeHistoryEntry:
        """Test DividendeHistoryEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DividendeHistoryEntry`
        """
        model = DividendeHistoryEntry()
        if include_optional:
            return DividendeHistoryEntry(
                pays = '',
                montant = 1.337,
                timestamp = 56
            )
    ...
    def testDividendeHistoryEntry(self):
        """Test DividendeHistoryEntry"""
