...
class TestEnterpriseBankLog(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> EnterpriseBankLog:
        """Test EnterpriseBankLog
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnterpriseBankLog`
        """
        model = EnterpriseBankLog()
        if include_optional:
            return EnterpriseBankLog(
                name = 'tax',
                amount = 74.5,
    ...
    def testEnterpriseBankLog(self):
        """Test EnterpriseBankLog"""
