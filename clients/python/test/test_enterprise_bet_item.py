...
class TestEnterpriseBetItem(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> EnterpriseBetItem:
        """Test EnterpriseBetItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnterpriseBetItem`
        """
        model = EnterpriseBetItem()
        if include_optional:
            return EnterpriseBetItem(
    ...
    def testEnterpriseBetItem(self):
        """Test EnterpriseBetItem"""
