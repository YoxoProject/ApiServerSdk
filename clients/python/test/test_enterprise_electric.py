...
class TestEnterpriseElectric(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> EnterpriseElectric:
        """Test EnterpriseElectric
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnterpriseElectric`
        """
    ...
    def testEnterpriseElectric(self):
        """Test EnterpriseElectric"""
