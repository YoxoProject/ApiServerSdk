...
class TestEnterpriseFarm(unittest.TestCase):
    """EnterpriseFarm unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EnterpriseFarm:
        """Test EnterpriseFarm
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnterpriseFarm`
        """
        model = EnterpriseFarm()
        if include_optional:
            return EnterpriseFarm(
                type = 'petrol',
                name = 'Pompouasie',
                age = 997,
