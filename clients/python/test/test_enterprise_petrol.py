...
class TestEnterprisePetrol(unittest.TestCase):
    """EnterprisePetrol unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EnterprisePetrol:
        """Test EnterprisePetrol
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnterprisePetrol`
        """
        model = EnterprisePetrol()
        if include_optional:
            return EnterprisePetrol(
                type = 'petrol',
                name = 'Pompouasie',
                age = 997,
