...
class TestEnterpriseRealEstate(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> EnterpriseRealEstate:
        """Test EnterpriseRealEstate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnterpriseRealEstate`
        """
    ...
    def testEnterpriseRealEstate(self):
        """Test EnterpriseRealEstate"""
