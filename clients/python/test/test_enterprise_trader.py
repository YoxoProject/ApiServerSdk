...
class TestEnterpriseTrader(unittest.TestCase):
    """EnterpriseTrader unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EnterpriseTrader:
        """Test EnterpriseTrader
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnterpriseTrader`
        """
        model = EnterpriseTrader()
        if include_optional:
            return EnterpriseTrader(
                type = 'petrol',
                name = 'Pompouasie',
                age = 997,
