...
class TestHalloween2025Entry(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Halloween2025Entry:
        """Test Halloween2025Entry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Halloween2025Entry`
        """
        model = Halloween2025Entry()
        if include_optional:
            return Halloween2025Entry(
                username = 'Romaindu35',
                demons_killed = 450,
                tickets = 15,
                lost_souls_count = 87,
    ...
    def testHalloween2025Entry(self):
        """Test Halloween2025Entry"""
