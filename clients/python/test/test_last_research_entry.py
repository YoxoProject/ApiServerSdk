...
class TestLastResearchEntry(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LastResearchEntry:
        """Test LastResearchEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LastResearchEntry`
        """
        model = LastResearchEntry()
        if include_optional:
            return LastResearchEntry(
                domain = 'technology',
                level = 6,
    ...
    def testLastResearchEntry(self):
        """Test LastResearchEntry"""
