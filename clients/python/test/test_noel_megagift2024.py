...
class TestNoelMegagift2024(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NoelMegagift2024:
        """Test NoelMegagift2024
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NoelMegagift2024`
        """
        model = NoelMegagift2024()
        if include_optional:
