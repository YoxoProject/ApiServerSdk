...
class TestNoelMegagift2024Entry(unittest.TestCase):
    """NoelMegagift2024Entry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NoelMegagift2024Entry:
        """Test NoelMegagift2024Entry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NoelMegagift2024Entry`
        """
        model = NoelMegagift2024Entry()
        if include_optional:
            return NoelMegagift2024Entry(
                username = 'Mat4628149',
                server = 'orange',
    ...
    def testNoelMegagift2024Entry(self):
        """Test NoelMegagift2024Entry"""
