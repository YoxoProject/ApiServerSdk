...
class TestNoelMegagift2025Entry(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NoelMegagift2025Entry:
        """Test NoelMegagift2025Entry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NoelMegagift2025Entry`
        """
        model = NoelMegagift2025Entry()
        if include_optional:
            return NoelMegagift2025Entry(
                username = 'Paskap',
                server = 'red',
    ...
    def testNoelMegagift2025Entry(self):
        """Test NoelMegagift2025Entry"""
