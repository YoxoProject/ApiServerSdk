...
class TestPillageCountry(unittest.TestCase):
    """PillageCountry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PillageCountry:
        """Test PillageCountry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PillageCountry`
        """
        model = PillageCountry()
        if include_optional:
            return PillageCountry(
                data = [
                    yoxo_api_client.models.pillage_country_entry.PillageCountryEntry(
                        name = 'France', 
                        level = 10, 
                        players = 5, 
                        notation_position = 1, 
