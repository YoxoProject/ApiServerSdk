...
class TestPillageCountryEntry(unittest.TestCase):
    """PillageCountryEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PillageCountryEntry:
        """Test PillageCountryEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PillageCountryEntry`
        """
        model = PillageCountryEntry()
        if include_optional:
            return PillageCountryEntry(
                name = 'France',
                level = 10,
                players = 5,
                notation_position = 1,
    ...
    def testPillageCountryEntry(self):
        """Test PillageCountryEntry"""
