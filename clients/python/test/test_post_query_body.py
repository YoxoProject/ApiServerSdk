...
class TestPostQueryBody(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostQueryBody:
        """Test PostQueryBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostQueryBody`
        """
        model = PostQueryBody()
        if include_optional:
            return PostQueryBody(
                filter = 'builder>100000;builderPosition<100',
                page = 1,
                size = 50
            )
        else:
