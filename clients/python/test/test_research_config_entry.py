...
class TestResearchConfigEntry(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ResearchConfigEntry:
        """Test ResearchConfigEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResearchConfigEntry`
        """
        model = ResearchConfigEntry()
        if include_optional:
            return ResearchConfigEntry(
                name = 'Général',
                max_level = 15,
    ...
    def testResearchConfigEntry(self):
        """Test ResearchConfigEntry"""
