...
class TestResearchLevelEntry(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ResearchLevelEntry:
        """Test ResearchLevelEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResearchLevelEntry`
        """
        model = ResearchLevelEntry()
        if include_optional:
            return ResearchLevelEntry(
                level = 2,
                duration = 15,
    ...
    def testResearchLevelEntry(self):
        """Test ResearchLevelEntry"""
