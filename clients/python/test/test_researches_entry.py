...
class TestResearchesEntry(unittest.TestCase):
    """ResearchesEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResearchesEntry:
        """Test ResearchesEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResearchesEntry`
        """
        model = ResearchesEntry()
        if include_optional:
            return ResearchesEntry(
                general = 56,
                resource = 56,
                military = 56,
                industry = 56,
