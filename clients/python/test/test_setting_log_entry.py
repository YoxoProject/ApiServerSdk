...
class TestSettingLogEntry(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SettingLogEntry:
        """Test SettingLogEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SettingLogEntry`
        """
        model = SettingLogEntry()
        if include_optional:
            return SettingLogEntry(
                user = '',
                action = '',
                target = '',
                timestamp = 56
