...
class TestWarEntry(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> WarEntry:
        """Test WarEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WarEntry`
        """
        model = WarEntry()
        if include_optional:
            return WarEntry(
                ...
                wars_initiated_by = 'Romaindu35',
                reason = 'KILL_WILDERNESS',
                target = 'Romaindu35',
                target_grade = 'LEADER',
                status = 'IN_PROGRESS',
                winner = 'TerreSigny',
