...
class BankLogEntry(BaseModel):
    """
    Log bancaire
    """ # noqa: E501
    amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Montant de la transaction")
    timestamp: Optional[StrictInt] = Field(default=None, description="Timestamp de la transaction")
    pseudo: Optional[StrictStr] = Field(default=None, description="Joueur ayant effectué la transaction")
    __properties: ClassVar[List[str]] = ["amount", "timestamp", "pseudo"]
