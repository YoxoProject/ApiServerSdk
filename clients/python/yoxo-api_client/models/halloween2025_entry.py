...
class Halloween2025Entry(BaseModel):
    """
    Statistiques individuelles d'un joueur pour l'événement Halloween 2025
    """ # noqa: E501
    username: Optional[StrictStr] = Field(default=None, description="Le nom d'utilisateur du joueur")
    demons_killed: Optional[StrictInt] = Field(default=None, description="Nombre de démons tués dans le Nether", alias="demonsKilled")
    tickets: Optional[StrictInt] = Field(default=None, description="Nombre de tickets obtenus pour la tombola finale. 1 ticket est obtenu toutes les 200 âmes collectées, avec des tickets bonus pour le top 10 des chasseurs d'âmes")
    lost_souls_count: Optional[StrictInt] = Field(default=None, description="Nombre d'âmes égarées retrouvées dans les capitales (/spawn) des différents serveurs", alias="lostSoulsCount")
    extracted_souls: Optional[StrictInt] = Field(default=None, description="Nombre de points gagnés par le joueur en battant les démons du Nether (Démon de niveau 1: 1 âme, de niveau 2: 4 âmes, de niveau 3: 40 âmes)", alias="extractedSouls")
    lost_souls: Optional[StrictInt] = Field(default=None, description="Nombre de points gagnés par le joueur en retrouvant les âmes égarées dans les capitales", alias="lostSouls")
    __properties: ClassVar[List[str]] = ["username", "demonsKilled", "tickets", "lostSoulsCount", "extractedSouls", "lostSouls"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "demonsKilled": obj.get("demonsKilled"),
            "tickets": obj.get("tickets"),
            "lostSoulsCount": obj.get("lostSoulsCount"),
            "extractedSouls": obj.get("extractedSouls"),
            "lostSouls": obj.get("lostSouls")
        })
        return _obj
