...
class ResearchesEntry(BaseModel):
    """
    Niveaux de recherches
    """ # noqa: E501
    general: Optional[StrictInt] = Field(default=None, description="Niveau de recherche sur la branche générale")
    resource: Optional[StrictInt] = Field(default=None, description="Niveau de recherche sur la branche ressource")
    military: Optional[StrictInt] = Field(default=None, description="Niveau de recherche sur la branche militaire")
    industry: Optional[StrictInt] = Field(default=None, description="Niveau de recherche sur la branche industrielle")
    technology: Optional[StrictInt] = Field(default=None, description="Niveau de recherche sur la branche technologique")
    __properties: ClassVar[List[str]] = ["general", "resource", "military", "industry", "technology"]
