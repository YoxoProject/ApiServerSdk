...
class WarCondition(BaseModel):
    """
    Valeurs des conditions de victoire (objectifs ou progression)
    """ # noqa: E501
    kill: Optional[StrictInt] = Field(default=None, description="Nombre de kills effectués")
    victory: Optional[StrictInt] = Field(default=None, description="Nombre d'assauts gagnés")
    missile_points: Optional[StrictInt] = Field(default=None, description="Nombre de points obtenus lors des tirs de missile", alias="missilePoints")
    assault_points: Optional[StrictInt] = Field(default=None, description="Nombre de points obtenus lors des assauts", alias="assaultPoints")
    antimatter: Optional[StrictInt] = Field(default=None, description="Nombre d'antimmater tiré")
    redmatter: Optional[StrictInt] = Field(default=None, description="Nombre de redmatter tiré")
    __properties: ClassVar[List[str]] = ["kill", "victory", "missilePoints", "assaultPoints", "antimatter", "redmatter"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "missilePoints": obj.get("missilePoints"),
            "assaultPoints": obj.get("assaultPoints"),
