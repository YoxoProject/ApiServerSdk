...
class WarRewards(BaseModel):
    """
    Récompenses accordées au pays vainqueur de la guerre
    """ # noqa: E501
    dollars: Optional[StrictInt] = Field(default=None, description="Montant en dollars gagné")
    power: Optional[StrictInt] = Field(default=None, description="Points de power gagnés")
    claims: Optional[StrictInt] = Field(default=None, description="Nombre de claims (territoires) gagnés")
    peace: Optional[StrictInt] = Field(default=None, description="Nombre de jours de trêve forcée après la guerre pendant lesquels les pays ne peuvent plus s'attaquer")
    __properties: ClassVar[List[str]] = ["dollars", "power", "claims", "peace"]
