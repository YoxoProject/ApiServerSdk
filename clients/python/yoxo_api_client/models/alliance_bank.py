...
class AllianceBank(BaseModel):
    """
    Banque de l'alliance
    """ # noqa: E501
    current_account_balance: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="L'argent sur le compte courant de l'alliance", alias="currentAccountBalance")
    blocked_account_balance: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="L'argent sur le compte bloqué de l'alliance", alias="blockedAccountBalance")
    __properties: ClassVar[List[str]] = ["currentAccountBalance", "blockedAccountBalance"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "currentAccountBalance": obj.get("currentAccountBalance"),
            "blockedAccountBalance": obj.get("blockedAccountBalance")
        })
        return _obj
