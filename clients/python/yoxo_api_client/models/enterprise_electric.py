...
class EnterpriseElectric(BaseModel):
    """
    ...
    total: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Électricité totale distribué (MJ)")
    available: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Électricité disponible (MJ)")
    allow_country: Optional[StrictBool] = Field(default=None, description="Autoriser la vente au pays", alias="allowCountry")
    allow_ally: Optional[StrictBool] = Field(default=None, description="Autoriser la vente aux alliés", alias="allowAlly")
    allow_all: Optional[StrictBool] = Field(default=None, description="Autoriser la vente à tous", alias="allowAll")
    associated_country: Optional[StrictStr] = Field(default=None, description="Pays associé (semble être le pays du chef de l'entreprise)", alias="associatedCountry")
    price: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Prix actuel de l'électricité ($/GJ)")
    price_average: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Prix moyen, à l'échelle du serveur ($/GJ)", alias="priceAverage")
    countries_sell: Optional[Dict[str, Union[StrictFloat, StrictInt]]] = Field(default=None, description="Ventes par pays", alias="countriesSell")
    history_generated: Optional[Dict[str, Union[StrictFloat, StrictInt]]] = Field(default=None, description="Historique de l'électricité vendue", alias="historyGenerated")
    history_collected: Optional[Dict[str, Union[StrictFloat, StrictInt]]] = Field(default=None, description="Historique de l'électricité générée/collectée par les collecteurs", alias="historyCollected")
    __properties: ClassVar[List[str]] = ["type", "name", "age", "description", "services", "owner", "flag", "cadres", "employees", "contractsDone", "disputes", "contractsSuccess", "turnover", "permissions", "bank", "total", "available", "allowCountry", "allowAlly", "allowAll", "associatedCountry", "price", "priceAverage", "countriesSell", "historyGenerated", "historyCollected"]
