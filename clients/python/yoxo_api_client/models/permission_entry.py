...
class PermissionEntry(BaseModel):
    ...
    Permission de pays
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Nom de la permission")
    description: Optional[StrictStr] = Field(default=None, description="Description de la permission")
    leader: Optional[StrictBool] = Field(default=None, description="Permission accordée au leader")
    officer: Optional[StrictBool] = Field(default=None, description="Permission accordée aux officiers")
    member: Optional[StrictBool] = Field(default=None, description="Permission accordée aux membres")
    recruit: Optional[StrictBool] = Field(default=None, description="Permission accordée aux recrues")
    ally: Optional[StrictBool] = Field(default=None, description="Permission accordée aux alliés")
    neutral: Optional[StrictBool] = Field(default=None, description="Permission accordée aux pays sans relation particulière")
    enemy: Optional[StrictBool] = Field(default=None, description="Permission accordée aux ennemis")
    __properties: ClassVar[List[str]] = ["name", "description", "leader", "officer", "member", "recruit", "ally", "neutral", "enemy"]
