...
class SettingLogEntry(BaseModel):
    """
    Log de pays
    """ # noqa: E501
    user: Optional[StrictStr] = Field(default=None, description="Joueur ayant effectué l'action")
    action: Optional[StrictStr] = Field(default=None, description="Action effectuée")
    target: Optional[StrictStr] = Field(default=None, description="Joueur cible de l'action (par exemple lors d'une expulsion)")
    timestamp: Optional[StrictInt] = Field(default=None, description="Timestamp de l'action")
    __properties: ClassVar[List[str]] = ["user", "action", "target", "timestamp"]
