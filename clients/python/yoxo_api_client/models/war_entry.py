...
class WarEntry(BaseModel):
    ...
    def reason_validate_enum(cls, value):
        ...
        if value not in set(['KILL_WILDERNESS', 'PROVOCATION', 'TERRITORIAL_EXPANSION', 'TERRITORIAL_DEFENSE', 'TREASON', 'INTRUSION', 'SCAM', 'TPKILL', 'COLONY_IMDEPENDENCE', 'COLONY_REFUSAL', 'COLONY_PROTECTION', 'COLONY_STEAL', 'BUFFER_COUNTRY', 'UNDER_POWER', 'REPRISAL', 'FOLLOW_WAR', 'MMR500', 'EMPIRE_RIVALITY', 'WAR_REVENGE', 'BOMBING_ASSISTANCE', 'WARZONE_DOMINATION', 'PROTECTORAT']):
            raise ValueError("must be one of enum values ('KILL_WILDERNESS', 'PROVOCATION', 'TERRITORIAL_EXPANSION', 'TERRITORIAL_DEFENSE', 'TREASON', 'INTRUSION', 'SCAM', 'TPKILL', 'COLONY_IMDEPENDENCE', 'COLONY_REFUSAL', 'COLONY_PROTECTION', 'COLONY_STEAL', 'BUFFER_COUNTRY', 'UNDER_POWER', 'REPRISAL', 'FOLLOW_WAR', 'MMR500', 'EMPIRE_RIVALITY', 'WAR_REVENGE', 'BOMBING_ASSISTANCE', 'WARZONE_DOMINATION', 'PROTECTORAT')")
        return value
