...
class WarMissile(BaseModel):
    """
    Détails d'un missile lancé
    """ # noqa: E501
    launched_at: Optional[StrictInt] = Field(default=None, description="Timestamp (ms) du lancement du missile", alias="launchedAt")
    missile: Optional[StrictStr] = Field(default=None, description="Type de missile lancé")
    missile_points: Optional[StrictInt] = Field(default=None, description="Points de missile consommés pour ce lancement", alias="missilePoints")
    launcher: Optional[StrictStr] = Field(default=None, description="Joueur ayant lancé le missile")
    launcher_country: Optional[StrictStr] = Field(default=None, description="Pays du joueur ayant lancé le missile", alias="launcherCountry")
    __properties: ClassVar[List[str]] = ["launchedAt", "missile", "missilePoints", "launcher", "launcherCountry"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "missile": obj.get("missile"),
            "missilePoints": obj.get("missilePoints"),
            "launcher": obj.get("launcher"),
            "launcherCountry": obj.get("launcherCountry")
        })
        return _obj
