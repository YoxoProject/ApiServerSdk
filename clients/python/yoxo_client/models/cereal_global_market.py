...
class CerealGlobalMarket(BaseModel):
    """
    CerealGlobalMarket
    """ # noqa: E501
    data: Optional[CerealGlobalMarketEntry] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": CerealGlobalMarketEntry.from_dict(obj["data"]) if obj.get("data") is not None else None,
