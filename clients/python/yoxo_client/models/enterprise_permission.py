...
class EnterprisePermission(BaseModel):
    ...
    owner: Optional[StrictBool] = Field(default=None, description="Si le chef de l'entreprise peut utiliser cette permission")
    cadre: Optional[StrictBool] = Field(default=None, description="Si les cadres peuvent utiliser cette permission")
    employee: Optional[StrictBool] = Field(default=None, description="Si les employés peuvent utiliser cette permission")
    __properties: ClassVar[List[str]] = ["name", "owner", "cadre", "employee"]
