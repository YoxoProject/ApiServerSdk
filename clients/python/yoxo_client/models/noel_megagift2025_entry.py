...
class NoelMegagift2025Entry(BaseModel):
    """
    Données d'un tirage du méga cadeau de Noël 2025
    """ # noqa: E501
    username: Optional[StrictStr] = Field(default=None, description="Le pseudo du joueur ayant réalisé le tirage")
    server: Optional[StrictStr] = Field(default=None, description="Le serveur sur lequel le méga cadeau a été ouvert")
    timestamp: Optional[StrictInt] = Field(default=None, description="Timestamp du moment où le tirage a été effectué (en ms)")
    loots: Optional[List[StrictStr]] = Field(default=None, description="Liste des items obtenus par le joueur lors du tirage")
    __properties: ClassVar[List[str]] = ["username", "server", "timestamp", "loots"]
