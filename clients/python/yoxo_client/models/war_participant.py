...
class WarParticipant(BaseModel):
    ...
    """ # noqa: E501
    country: Optional[StrictStr] = Field(default=None, description="Nom du pays participant")
    remaining_missiles_points: Optional[StrictInt] = Field(default=None, description="Points de missile restants utilisables par le pays", alias="remainingMissilesPoints")
    inactivity: Optional[StrictInt] = Field(default=None, description="Pourcentage d'inactivité du pays. Augmente de 3% si les critères de connexion ne sont pas remplis pendant 2h")
    progress: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Pourcentage de progression vers la validation des conditions de victoire (0-100%). À 100%, le pays gagne")
    condition: Optional[WarCondition] = None
    __properties: ClassVar[List[str]] = ["country", "remainingMissilesPoints", "inactivity", "progress", "condition"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "remainingMissilesPoints": obj.get("remainingMissilesPoints"),
            "inactivity": obj.get("inactivity"),
            "progress": obj.get("progress"),
            "condition": WarCondition.from_dict(obj["condition"]) if obj.get("condition") is not None else None
        })
        return _obj
