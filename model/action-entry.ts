...
export interface ActionEntry {
     ...
     * Statut de l\'action
     */
    'status'?: ActionEntryStatusEnum;
}

export const ActionEntryStatusEnum = {
    Locked: 'LOCKED',
    Unlocked: 'UNLOCKED'
} as const;

export type ActionEntryStatusEnum = typeof ActionEntryStatusEnum[keyof typeof ActionEntryStatusEnum];
