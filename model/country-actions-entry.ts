...
// May contain unused imports in some cases
// @ts-ignore
import type { DividendeClassementEntry } from './dividende-classement-entry';
// May contain unused imports in some cases
// @ts-ignore
import type { DividendeHistoryEntry } from './dividende-history-entry';

/**
 * Actions du pays
 */
export interface CountryActionsEntry {
    /**
     ...
     */
    'dividendesClassement'?: Array<DividendeClassementEntry>;
    /**
     * Historique des dividendes perçus
     */
    'dividendesHistory'?: Array<DividendeHistoryEntry>;
    /**
