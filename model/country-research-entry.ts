...
// @ts-ignore
import type { LastResearchEntry } from './last-research-entry';

/**
 * Données de R&D pour un pays
 */
export interface CountryResearchEntry {
    /**
     * Nom du pays
     */
    'country'?: string;
     ...
     */
    'researchesLevels'?: { [key: string]: number; };
    'lastResearch'?: LastResearchEntry;
    /**
     * Valeurs actuelles des conditions de recherche. Celles-ci sont globales
     */
    'researchesConditionsValues'?: { [key: string]: number; };
}
