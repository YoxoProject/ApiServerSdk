...
// @ts-ignore
import type { PermissionEntry } from './permission-entry';
// May contain unused imports in some cases
// @ts-ignore
import type { SettingLogEntry } from './setting-log-entry';

/**
 * Paramètres du pays
 */
export interface CountrySettingsEntry {
    /**
