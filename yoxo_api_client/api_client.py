...
from yoxo_api_client.api_response import ApiResponse, T as ApiResponseT
import yoxo_api_client.models
from yoxo_api_client import rest
from yoxo_api_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(yoxo_api_client.models, klass)
