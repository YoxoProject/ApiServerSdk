...
class ActionEntry(BaseModel):
    ...
    Action détenue
    """ # noqa: E501
    owner: Optional[StrictStr] = Field(default=None, description="Pays propriétaire de l'action")
    status: Optional[StrictStr] = Field(default=None, description="Statut de l'action")
    __properties: ClassVar[List[str]] = ["owner", "status"]
