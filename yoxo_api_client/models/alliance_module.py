...
class AllianceModule(BaseModel):
    """
    Module de la station spatiale
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="L'id du module")
    direction: Optional[StrictStr] = Field(default=None, description="La direction dans laquelle est orienté le module")
    coordinates: Optional[AllianceModuleCoordinates] = None
    name: Optional[StrictStr] = Field(default=None, description="Le nom du module")
    description: Optional[StrictStr] = Field(default=None, description="La description du module")
    __properties: ClassVar[List[str]] = ["id", "direction", "coordinates", "name", "description"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "coordinates": AllianceModuleCoordinates.from_dict(obj["coordinates"]) if obj.get("coordinates") is not None else None,
            "name": obj.get("name"),
