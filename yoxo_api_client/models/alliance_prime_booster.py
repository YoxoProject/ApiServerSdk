...
class AlliancePrimeBooster(BaseModel):
    """
    Membre de l'alliance
    """ # noqa: E501
    username: Optional[StrictStr] = Field(default=None, description="Le pseudonyme du joueur")
    boost_type: Optional[StrictStr] = Field(default=None, description="Le type de boost", alias="boostType")
    boost_value: Optional[StrictInt] = Field(default=None, description="Le nombre de joueur pour lequel compte ce joueur au total de boostPoints de AlliancePrimeBoost.", alias="boostValue")
    __properties: ClassVar[List[str]] = ["username", "boostType", "boostValue"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "boostType": obj.get("boostType"),
            "boostValue": obj.get("boostValue")
        })
        return _obj
