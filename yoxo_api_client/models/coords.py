...
class Coords(BaseModel):
    ...
    Coordonnées
    """ # noqa: E501
    x: Optional[StrictInt] = Field(default=None, description="Coordonnée X")
    y: Optional[StrictInt] = Field(default=None, description="Coordonnée Y")
    z: Optional[StrictInt] = Field(default=None, description="Coordonnée Z")
