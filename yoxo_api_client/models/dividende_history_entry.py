...
class DividendeHistoryEntry(BaseModel):
    """
    Historique dividendes
    """ # noqa: E501
    pays: Optional[StrictStr] = Field(default=None, description="Pays ayant versé les dividendes")
    montant: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Montant des dividendes perçus de ce pays")
    timestamp: Optional[StrictInt] = Field(default=None, description="Timestamp du versement des dividendes")
    __properties: ClassVar[List[str]] = ["pays", "montant", "timestamp"]
