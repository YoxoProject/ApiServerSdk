...
class EnterpriseBank(BaseModel):
    """
    Informations bancaires d'une entreprise
    """ # noqa: E501
    bank: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Solde bancaire actuel (positif ou nul)")
    flux14_days: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Flux bancaire des 14 derniers jours", alias="flux14Days")
    in_progress_contracts: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Montant des contrats en cours (positif ou nul)", alias="inProgressContracts")
    salaries14_days: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Salaires versés sur 14 jours (négatif ou nul)", alias="salaries14Days")
    taxes14_days: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Taxes payées sur 14 jours (négatif ou nul)", alias="taxes14Days")
    logs: Optional[List[EnterpriseBankLog]] = Field(default=None, description="Historique des transactions")
    __properties: ClassVar[List[str]] = ["bank", "flux14Days", "inProgressContracts", "salaries14Days", "taxes14Days", "logs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bank": obj.get("bank"),
            "flux14Days": obj.get("flux14Days"),
            "inProgressContracts": obj.get("inProgressContracts"),
            "salaries14Days": obj.get("salaries14Days"),
            "taxes14Days": obj.get("taxes14Days"),
            "logs": [EnterpriseBankLog.from_dict(_item) for _item in obj["logs"]] if obj.get("logs") is not None else None
        })
        return _obj
