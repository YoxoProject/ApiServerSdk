...
class EnterpriseBetItem(BaseModel):
    """
    Pari proposé par une entreprise
    """ # noqa: E501
    deadline_time: Optional[StrictInt] = Field(default=None, description="Timestamp de fin du pari", alias="deadlineTime")
    min_bet: Optional[StrictInt] = Field(default=None, description="Mise minimale (en dollar)", alias="minBet")
    number_of_players: Optional[StrictInt] = Field(default=None, description="Nombre de joueurs ayant parié", alias="numberOfPlayers")
    title: Optional[StrictStr] = Field(default=None, description="Titre du pari")
    option1: Optional[StrictStr] = Field(default=None, description="Première option")
    option2: Optional[StrictStr] = Field(default=None, description="Deuxième option")
    status: Optional[StrictStr] = Field(default=None, description="Statut du pari")
    __properties: ClassVar[List[str]] = ["deadlineTime", "minBet", "numberOfPlayers", "title", "option1", "option2", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "deadlineTime": obj.get("deadlineTime"),
            "minBet": obj.get("minBet"),
