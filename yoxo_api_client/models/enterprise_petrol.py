...
class EnterprisePetrol(BaseModel):
    """
    ...
    history_generated: Optional[Dict[str, Union[StrictFloat, StrictInt]]] = Field(default=None, description="Historique du pétrole vendue", alias="historyGenerated")
    history_collected: Optional[Dict[str, Union[StrictFloat, StrictInt]]] = Field(default=None, description="Historique du pétrole collectée", alias="historyCollected")
    total: Optional[StrictInt] = Field(default=None, description="Total du pétrole distribué (L)")
    available: Optional[StrictInt] = Field(default=None, description="Pétrole disponible (L)")
    ...
    price: Optional[StrictInt] = Field(default=None, description="Prix actuel du pétrole ($/100L)")
    price_average: Optional[StrictInt] = Field(default=None, description="Prix moyen, à l'échelle du serveur ($/100L)", alias="priceAverage")
    __properties: ClassVar[List[str]] = ["type", "name", "age", "description", "services", "owner", "flag", "cadres", "employees", "contractsDone", "disputes", "contractsSuccess", "turnover", "permissions", "bank", "historyGenerated", "historyCollected", "total", "available", "allowCountry", "allowAlly", "allowAll", "associatedCountry", "price", "priceAverage"]
