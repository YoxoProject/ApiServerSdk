...
class EnterpriseRealEstate(BaseModel):
    """
    ...
    parcelles: Optional[List[Parcelle]] = Field(default=None, description="Liste des parcelles de l'entreprise")
    __properties: ClassVar[List[str]] = ["type", "name", "age", "description", "services", "owner", "flag", "cadres", "employees", "contractsDone", "disputes", "contractsSuccess", "turnover", "permissions", "bank", "parcelles"]
