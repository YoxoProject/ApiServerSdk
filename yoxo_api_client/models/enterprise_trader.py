...
class EnterpriseTrader(BaseModel):
    """
    ...
    history: Optional[Dict[str, Union[StrictFloat, StrictInt]]] = Field(default=None, description="Historique des rendements journaliers par date")
    total_generated: Optional[StrictInt] = Field(default=None, description="Argent total généré", alias="totalGenerated")
    sum_investment: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Somme totale investie par l'ensemble des investisseurs", alias="sumInvestment")
    total_investors: Optional[StrictInt] = Field(default=None, description="Nombre total d'investisseurs", alias="totalInvestors")
    __properties: ClassVar[List[str]] = ["type", "name", "age", "description", "services", "owner", "flag", "cadres", "employees", "contractsDone", "disputes", "contractsSuccess", "turnover", "permissions", "bank", "history", "totalGenerated", "sumInvestment", "totalInvestors"]
