...
class Halloween2025(BaseModel):
    """
    Halloween2025
    """ # noqa: E501
    data: Optional[List[Halloween2025Entry]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [Halloween2025Entry.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
