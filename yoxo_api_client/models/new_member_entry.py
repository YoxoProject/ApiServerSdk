...
class NewMemberEntry(BaseModel):
    """
    Détail sur la formation d'un nouveau joueur
    """ # noqa: E501
    pseudo: Optional[StrictStr] = Field(default=None, description="Pseudo du nouveau joueur")
    played_time: Optional[StrictInt] = Field(default=None, description="Temps de jeu sur le serveur (en secondes)", alias="playedTime")
    reward_power: Optional[StrictInt] = Field(default=None, description="Récompenses de power débloquées par la formation du joueur", alias="rewardPower")
    reward_power_max: Optional[StrictInt] = Field(default=None, description="Récompenses de power maximale espérable par la formation du joueur (déjà obtenu et à venir)", alias="rewardPowerMax")
    reward_money: Optional[StrictInt] = Field(default=None, description="Récompenses en dollard débloquées par la formation du joueur", alias="rewardMoney")
    reward_money_max: Optional[StrictInt] = Field(default=None, description="Récompenses en dollard maximale espérable par la formation du joueur (déjà obtenu et à venir)", alias="rewardMoneyMax")
    step: Optional[StrictInt] = Field(default=None, description="Étape de formation actuelle du joueur")
    __properties: ClassVar[List[str]] = ["pseudo", "playedTime", "rewardPower", "rewardPowerMax", "rewardMoney", "rewardMoneyMax", "step"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "playedTime": obj.get("playedTime"),
            "rewardPower": obj.get("rewardPower"),
            "rewardPowerMax": obj.get("rewardPowerMax"),
            "rewardMoney": obj.get("rewardMoney"),
            "rewardMoneyMax": obj.get("rewardMoneyMax"),
            "step": obj.get("step")
        })
        return _obj
