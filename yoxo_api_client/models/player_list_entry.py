...
class PlayerListEntry(BaseModel):
    ...
    PlayerListEntry
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Le pseudonyme du joueur")
    country: Optional[StrictStr] = Field(default=None, description="Le pays du joueur, écrit en toutes lettres. Si le joueur est sans pays, la chaine retourné sera vide")
    power: Optional[StrictInt] = Field(default=None, description="Le power actuel du joueur")
    power_max: Optional[StrictInt] = Field(default=None, description="Le power maximum atteignable par le joueur", alias="powerMax")
    playtime: Optional[StrictInt] = Field(default=None, description="Le temps de jeu total du joueur sur le serveur (en secondes)")
    last_login: Optional[StrictInt] = Field(default=None, description="Le timestamp de la dernière connexion du joueur. Le timestamp est ici exprimé en secondes et correspond au nombre de secondes écoulées depuis le 1er janvier 1970, minuit UTC", alias="lastLogin")
    __properties: ClassVar[List[str]] = ["name", "country", "power", "powerMax", "playtime", "lastLogin"]
