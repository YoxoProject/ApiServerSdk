...
class ResearchConfigEntry(BaseModel):
    """
    Configuration d'une branche de R&D sur ses différents niveaux
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Nom de la branche R&D")
    max_level: Optional[StrictInt] = Field(default=None, description="Nombre de niveaux dans la branche", alias="maxLevel")
    description: Optional[StrictStr] = Field(default=None, description="Description de la branche")
    levels: Optional[List[ResearchLevelEntry]] = Field(default=None, description="Configuration des différents niveaux (conditions et récompenses)")
    __properties: ClassVar[List[str]] = ["name", "maxLevel", "description", "levels"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "levels": [ResearchLevelEntry.from_dict(_item) for _item in obj["levels"]] if obj.get("levels") is not None else None
        })
        return _obj
