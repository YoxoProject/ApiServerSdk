...
class ResearchLevelEntry(BaseModel):
    """
    Configuration d'un niveau de R&D
    """ # noqa: E501
    level: Optional[StrictInt] = Field(default=None, description="Numéro du niveau")
    duration: Optional[StrictInt] = Field(default=None, description="Durée de la recherche (en secondes)")
    conditions: Optional[List[StrictStr]] = Field(default=None, description="Liste des conditions requises pour débloquer ce niveau")
    rewards: Optional[List[StrictStr]] = Field(default=None, description="Liste des récompenses obtenues en complétant ce niveau")
    __properties: ClassVar[List[str]] = ["level", "duration", "conditions", "rewards"]
